...
<script type='text/javascript' src='<%=request.getContextPath() %>/dwr/interface/ajaxStudentController.js'></script>
<!doctype html>
  	 ...
  	 <div class="am-u-sm-12 am-u-md-2">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
               <button type="button" id="openModel" class="am-btn am-btn-default" onclick="addStudent();"><span class="am-icon-plus"></span> 新增</button>
            </div>
          </div>
        </div>
        ...
        <div class="am-u-sm-12 am-u-md-2">
         ...
         <input id="studentCode" name="studentCode" type="text" class="am-form-field" placeholder="学生编号" style="width:200px;height: 32px;"/>
          </div>
        </div>
       
        <div class="am-u-sm-12 am-u-md-2">
          <div class="am-form-group">
            <input id="studentName" name="studentName" type="text" class="am-form-field" placeholder="学生姓名" style="width:200px;height: 32px;"/>
          </div>
        </div>
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table id="bookTable" style="text-align: center;"  class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr >
                <th style="text-align: center;" class="table-id">序号</th><th style="text-align: center;" class="table-type">学生编号</th><th style="text-align: center;" class="table-type">学生姓名</th><th style="text-align: center;" class="table-author am-hide-sm-only">年龄</th><th style="text-align: center;" class="table-title">性别</th><th style="text-align: center;" class="table-date am-hide-sm-only">入学日期</th><th style="text-align: center;" class="table-date am-hide-sm-only">联系电话</th><th style="text-align: center;" class="table-author am-hide-sm-only">家庭住址</th><th class="table-set">操作</th>
              </tr>
              </thead>
             <tbody id="tableBody">
			</tbody>
...
<script src="<%=basePath%>static/amaze/assets/js/app.js"></script>
  ...
  <script src="<%=basePath%>static/js/student.js"></script>
</body>
</html>

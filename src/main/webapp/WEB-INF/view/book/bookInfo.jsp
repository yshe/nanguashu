...
<p class="browsehappy">你正在使用<strong>过时</strong>的浏览器，Amaze UI 暂不支持。 请 <a href="http://browsehappy.com/" target="_blank">升级浏览器</a>
  以获得更好的体验！</p>
<![endif]-->
<div class="am-popup" id="my-popup" style="width: 900px;height: 300px; margin-left: 20%; margin-top: 10%;"align="center">
  <div class="am-popup-inner">
    <div class="am-popup-hd">
      <h4 class="am-popup-title" id="title">新增图书条目</h4>
  ...
  <form action="" class="am-form" data-am-validator >
              ...
              <div class="am-u-sm-6 am-u-md-4 am-text-right">
                	图书类别<font color="red">*</font>：
              </div>
              <div class="am-u-sm-4 am-u-md-4 am-u-end col-end">
                <select id="parentTypeId" data-am-selected="{btnSize: 'sm'}">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-4 am-u-md-4 am-u-end col-end">
                <input type="text" id="bookTypeName" class="am-input-sm" style="width:200px;height: 32px;">
              </div>
            </div>
             <div class="am-g am-margin-top am-form-group">
              <div class="am-u-sm-6 am-u-md-4 am-text-right">
                	<!-- 图书数量<font color="red">*</font>： -->
              </div>
              <div class="am-u-sm-4 am-u-md-4 am-u-end col-end">
                <input type="hidden" id="bookSum" value="0" class="am-input-sm" style="width:200px;height: 32px;">
              </div>
            </div>
  </form>
      ...
      <div class="am-tabs-bd">
        ...
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-4 am-u-md-4 am-u-end col-end">
                <input type="text" id="bookNo" class="am-input-sm" style="width:200px;height: 32px;">
              </div>
            </div>
             <div class="am-g am-margin-top am-form-group">
              <div class="am-u-sm-6 am-u-md-4 am-text-right">
  ...
  <div class="am-g">
  	 ...
  	 <div class="am-u-sm-12 am-u-md-2">
        ...
        <div class="am-u-sm-12 am-u-md-2">
         ...
         <select id="parentTypeIdSeach" name="parentTypeIds" data-am-selected="{btnSize: 'sm'}">
        	 <option value=" ">所有类别</option>
         	<c:forEach items="${bookTypeList }" var="bookType">
         		<option value="${bookType.id}">${bookType.commonCodeName }</option>
         	</c:forEach>
        ...
        <div class="am-u-sm-12 am-u-md-2">
          <div class="am-form-group">
         <select id="bookBorrowNumSeach" name="bookBorrowNums"  data-am-selected="{btnSize: 'sm'}">
        ...
        <div class="am-u-sm-12 am-u-md-2">
          <div class="am-form-group">
            <input id="bookTypeNameSeach" name="bookTypeNames" type="text" class="am-form-field" placeholder="图书名字" style="width:200px;height: 32px;"/>
          </div>
        </div>
         <div class="am-u-sm-12 am-u-md-2">
          <div class="am-form-group">
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table id="bookTable" style="text-align: center;"  class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr >
                <th style="text-align: center;" class="table-id">序号</th><th style="text-align: center;"x	 class="table-type">类别</th><th style="text-align: center;" class="table-author am-hide-sm-only">图书名</th><th style="text-align: center;" class="table-title">图书数量（本）</th><th style="text-align: center;" class="table-date am-hide-sm-only">借出数量</th><th style="text-align: center;" class="table-date am-hide-sm-only">库存数量</th><th  class="table-set">操作</th>
              </tr>
              </thead>
             <tbody id="tableBody">
			</tbody>
...
<script src="<%=basePath%>static/js/bookInfo.js"></script>
</body>
</html>
